...
import { every, reduce, some } from "generic-handler/built_in_generics/generic_collection"
...
export const all_layers_value_equal = (a: LayeredObject<any>, b: LayeredObject<any>) => reduce(get_annotation_layers(a), 
