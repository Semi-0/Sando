...
export const support_layer = make_annotation_layer("support", (get_name: () => string, 
    ...
    function get_procedure(name: string, arity: number): any | undefined{
        return default_merge_procedure(merge_set, empry_support_set())
    }
...
export const construct_defualt_support_set = (l: any[]) => construct_better_set(l, (a: string) => to_string(a))
